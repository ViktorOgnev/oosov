...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field locations on 'Album'
        db.create_table(u'photogallery_album_locations', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('album', models.ForeignKey(orm[u'photogallery.album'], null=False)),
            ('location', models.ForeignKey(orm[u'coltrane.location'], null=False))
        ))
        db.create_unique(u'photogallery_album_locations', ['album_id', 'location_id'])
    
    
    def backwards(self, orm):
        
        # Removing M2M table for field locations on 'Album'
        db.delete_table('photogallery_album_locations')
